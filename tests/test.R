...
## data.frame
  ## 1 var
    ...
    #   params = list(fireSense_SizePredict = list(newData = "dataFireSense_SizePredict")),
    #   inputs = data.frame(
...
## RasterLayer
  ## 1 var
    ...
    #   modules = list("fireSense_SizePredict"),
    #   paths = list(modulePath = " # replace with empty string instead"),
    #   params = list(fireSense_SizePredict = list(newData = "MDC_JUN")),
    #   inputs = data.frame(
  ...
  ## 6 var
    ...
    #   modules = list("fireSense_SizePredict"),
    #   paths = list(modulePath = " # replace with empty string instead"),
    #   params = list(fireSense_SizePredict = list(newData = c("MDC_JUN", "MDC_MJ", "HW", "DIST", "O", "WATER"))),
    #   inputs = data.frame(
