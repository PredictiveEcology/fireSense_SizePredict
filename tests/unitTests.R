...
test_dir(" # replace with empty string insteadfireSense_SizePredict/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file(" # replace with empty string insteadfireSense_SizePredict/tests/testthat/test-template.R")
